...
RUN apt-get -y install php7.1-mysqlnd php7.1-curl php7.1-gd php-pear php7.1-imagick php7.1-imap php7.1-mcrypt php7.1-xmlrpc php7.1-xsl php7.1-intl php7.1-mbstring;
